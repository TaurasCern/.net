using Enum_Praktika;
namespace Enum_Praktika_Tests
{
    [TestClass]
    public class Society_Tests
    {
        [TestMethod]
        public void Society_OldPeople_Test()
        {
            var fakePeople = new Society();
            fakePeople.People = new List<Person>()
            {
            ...
            var actual = fakePeople.OldPeople;
